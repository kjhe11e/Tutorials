...
class QuestionMethodTests(TestCase):
    def test_published_recently_and_not_in_future_question(self):
        """
...
def create_question(question_text, days):
    """
    Creates a question with given 'question_text' and published the given
    number of 'days' offset to current time (negative for questions from past,
...
class QuestionViewTests(TestCase):
    def test_index_view_with_no_questions(self):
        ...
        self.assertContains(response, "No polls are available at this time.")
        self.assertQuerysetEqual(response.context['latest_question_list'], [])

    def test_index_view_with_earlier_question(self):
        """
        Questions with publication_date within past 30 days will be shown on index page.
        """
    ...
    def test_index_view_with_future_question(self):
        """
        Questions with publication_date in future should not be displayed on index page.
        """
...
class QuestionIndexDetailTests(TestCase):
    def test_detail_view_with_future_question(self):
        """
        Detail view of question with publication_date in future should return 404: not found.
        """
    ...
    def test_detail_view_with_past_question(self):
        """
        Detail view of question with publication_date in past should display question's text.
        """
