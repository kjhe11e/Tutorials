...
class IndexView(generic.ListView):
    ...
    def get_queryset(self):
        """Return the five most recent questions."""
...
class DetailView(generic.DetailView):
    ...
    def get_queryset(self):
        """
        Exclude questions that aren't published yet (i.e. in future)
        """
...
def vote(request, question_id):
    # Note this function exposes race condition.
    # See https://docs.djangoproject.com/en/1.9/ref/models/expressions/#avoiding-race-conditions-using-f to fix.
